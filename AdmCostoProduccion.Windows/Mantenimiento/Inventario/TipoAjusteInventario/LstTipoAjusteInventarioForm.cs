...
{
    public partial class LstTipoAjusteInventarioForm : Form
    {
        private ObservableListSource<TipoAjusteInventarioViewModel> ViewModelList = new ObservableListSource<TipoAjusteInventarioViewModel>();
        ...
        private void Agregar()
        {
            try
            {
                var frm = new MntTipoAjusteInventarioForm(ViewModelList);
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void Modificar()
        {
            try
            {
                var viewModel = (TipoAjusteInventarioViewModel)tipoAjusteInventarioViewModelBindingSource.Current;
                var frm = new MntTipoAjusteInventarioForm(viewModel, ViewModelList);
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void Buscar()
        {
            try
            {
                ...
                var list = new ApplicationDbContext().TipoAjusteInventarios.Where(o =>
