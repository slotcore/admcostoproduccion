...
{
    public partial class MntAjusteInventarioDetalleForm : KryptonForm
    {
        #region Propiedades
        private AjusteInventarioDetalleViewModel ViewModel;
        private ObservableListSource<AjusteInventarioDetalleViewModel> ViewModelList;
        private List<UnidadMedidaViewModel> unidadMedidaViewModels;
        #endregion

        #region Constructor
        public MntAjusteInventarioDetalleForm(AjusteInventarioDetalleViewModel viewModel
            , ObservableListSource<AjusteInventarioDetalleViewModel> viewModelList)
        {
            InitializeComponent();
            ViewModel.CopyOf(viewModel);
            ViewModelList = viewModelList;
            ajusteInventarioDetalleViewModelBindingSource.DataSource = ViewModel;
            CargarCombos();
        }

        public MntAjusteInventarioDetalleForm(string parentId, ObservableListSource<AjusteInventarioDetalleViewModel> viewModelList)
        {
            InitializeComponent();
            ViewModel = new AjusteInventarioDetalleViewModel(parentId);
            ViewModelList = viewModelList;
            ajusteInventarioDetalleViewModelBindingSource.DataSource = ViewModel;
            CargarCombos();
        }
        ...
        {
            ajusteInventarioDetalleViewModelBindingSource.CancelEdit();
            this.Close();
        }
        ...
        private void Grabar()
        {
            try
            {
                ...
                ajusteInventarioDetalleViewModelBindingSource.EndEdit();
                ...
                else
                {
                    var viewModel = ViewModelList
                        .Where(o => o.AjusteInventarioDetalleId == ViewModel.AjusteInventarioDetalleId)
                        .FirstOrDefault();
                    viewModel.CopyOf(ViewModel);
                }
                this.Close();
